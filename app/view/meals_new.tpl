			...
			<div id="main_content">
				<form method="POST" action="<?= BASE_URL ?>/meals/create">
					<div class="meal_content">
						...
						<div class="meal_type">
							<label>Meal Type: <input type="text" name="meal_type"></label>
						</div>
						...
						<div class="time_to_prepare">
							<label>Time to Prepare: <input type="text" name="time_to_prepare"></label>
						</div>

						<div class="instructions">
							<label>Instructions: <input type="textarea" name="instructions"></label>
						</div>
					</div>
					<button class="red_button shadow_button" type="submit">Create Meal</button>
				</form>
			</div>
		</div>
